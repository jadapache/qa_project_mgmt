...
class BaseRepository(IGenericRepository[Dict[str, Any], str]):
    """
    Implementación base concreta de IGenericRepository para persistencia relacional.
    Proporciona operaciones SELECT, INSERT, UPDATE y DELETE genéricas.
    """
